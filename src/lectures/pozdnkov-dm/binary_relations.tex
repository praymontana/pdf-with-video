...
\begin{note}
	Добавляя ребро из $x$ в $z$ мы осуществляем транзитивное замыкание.
\end{note}

\begin{center}
	\section*{\LARGE\S 3 Отношение эквивалентности}
	\timestamp{26:57}
	\label{par:otnosh}
\end{center}
...
\begin{figure}[H]
	\centering
	\tikz{
		\draw[thick, black] (1.5,0.3) arc (0:180:2.5 and 1.2);
